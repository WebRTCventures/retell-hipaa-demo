...
- [x] 1. Create project structure and input variables
  - [x] 1.1 Create `terraform/variables.tf` with all input variable definitions
  ...
  - [x] 1.2 Create `terraform/data.tf` with Debian 12 AMI data source
  ...
  - [x] 1.3 Create `terraform/terraform.tfvars.example` with documented example values
...
- [x] 2. Implement networking and security
  - [x] 2.1 Create `terraform/main.tf` with provider and VPC networking resources
  ...
  - [x] 2.2 Create `terraform/security.tf` with security group and all rules
...
- [x] 3. Checkpoint - Validate networking configuration
...
- [x] 4. Implement EC2 instance and outputs
  - [x] 4.1 Create `terraform/user_data.sh` with FreePBX install script
  ...
  - [x] 4.2 Add EC2 instance and Elastic IP resources to `terraform/main.tf`
  ...
  - [x] 4.3 Create `terraform/outputs.tf` with all output values
...
- [x] 5. Final validation checkpoint
  - [x] 5.1 Run `terraform validate` and `terraform fmt -check` on the complete module
...
- [x] 6. Final checkpoint - Ensure all validations pass
